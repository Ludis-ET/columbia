...
- Components own their empty state by rendering `null` — never a placeholder.
- Server actions for all mutations; Zod-validate on client and server.
- One Zod schema per form, shared between both sides.
